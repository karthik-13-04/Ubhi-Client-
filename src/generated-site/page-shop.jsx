            ...
            <div className="product-grid" id="shop-products-container">
              <article className="product-card reveal">
                <div className="product-image-wrap">
                  <img src="/assets/ubhi-snail-mail-generated.png" alt="Volume 01 AUM snail mail package" />
                </div>
              ...
              <article className="product-card reveal">
                <div className="product-image-wrap">
                  <img src="/assets/ubhi-snail-mail-generated.png" alt="Volume 02 STILLNESS snail mail package" />
                </div>
                <div className="product-body">
                  <p className="eyebrow">
                    Snail Mail
            ...
            <form id="modal-shop-form" noValidate>
              ...
              <div id="shop-step-success" className="modal-step">
                ...
                <p className="modal-success-subtext">
                  A purchase receipt has been sent to your email. We will prepare your package with quiet care and dispatch it soon.
                </p>
