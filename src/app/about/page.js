      ...
      <section id="about" className="about section-pad">
        <div className="about-geo" aria-hidden="true">
          <svg viewBox="0 0 500 500" fill="none">
            ...
            {Array.from({ length: 12 }).map((_, index) => (
              <use key={index} href="#ab-petal" transform={`rotate(${index * 30} 250 250)`} />
            ))}
        ...
        <RevealOnScroll className="about-content">
          <div className="about-left">
            <Image src="/ubhi-logo-transparent.png" alt="Ubhi calligraphy mark" className="about-logo" width={160} height={120} />
            ...
            <div className="about-flourish" aria-hidden="true">
              <svg viewBox="0 0 180 28" fill="none">
            ...
            <div className="about-social" aria-label="Find Chelsea">
              <a className="soc-ig" href="https://instagram.com/ubhi.in" target="_blank" rel="noopener noreferrer" aria-label="Ubhi on Instagram">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7"><rect x="3" y="3" width="18" height="18" rx="5" /><circle cx="12" cy="12" r="4" /><circle cx="17.5" cy="6.5" r="1.1" fill="currentColor" stroke="none" /></svg>
              </a>
              ...
              <a className="soc-mail" href="mailto:hello@ubhi.in" aria-label="Email Ubhi">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.7"><rect x="3" y="5" width="18" height="14" rx="2" /><path d="M3.5 7l8.5 6 8.5-6" /></svg>
              </a>
            </div>
          </div>
          <div className="about-right">
            <p>For years, my world was defined by working across biomedical science, medical advertising, and pharmacy. I spent my days analyzing data and studying how to heal the body from the outside in. Yet, I felt a quiet pull toward a different kind of restoration, one that could not be measured in a lab.</p>
          ...
          <div className="about-cta">
            <a className="button button-secondary" href="/workshops">Begin your practice</a>
          </div>
        </RevealOnScroll>
      </section>
    </main>
